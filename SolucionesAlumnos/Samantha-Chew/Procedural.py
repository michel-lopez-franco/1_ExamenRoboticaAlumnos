"""
Procedural caves with collectible keys and autonomous agent.

====================Modificación del ejemplo base de Arcade:==================

- Se añaden llaves (sprites) en posiciones libres.
- Se implementa un algoritmo BFS para encontrar y recorrer la ruta más corta.
- El agente se mueve automáticamente celda por celda para recogerlas.
- Cuando todas las llaves son recogidas, el juego se pausa mostrando un mensaje.
- Se incluye un caso de prueba sencillo de BFS antes de iniciar el juego.

Encuentra la ruta más corta a la llave más cercana usando BFS.

====================Justificación=======================

BFS (Breadth-First Search) explora en anchura y garantiza la ruta más corta
en mapas tipo grid donde cada movimiento tiene el mismo costo.
"""
